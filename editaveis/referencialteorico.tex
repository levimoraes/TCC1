...
Este mesmo edital também apresenta outra tabela, Tabela \ref{tabela2}. Nessa, são mostrados outros detalhes que serão cobrados na entrega do software. Algumas características desta tabela devem ser salientadas, como por exemplo, algumas métricas (mais especificamente taxa de cobertura de código, complexidade por método e LCOM4), as quais não possuem valores definidos de cobrança, sendo, portanto, ajustados conforme o projeto.
\begin{table}[h]
\centering
